...
async function runSeedersDev() {
  try {
    console.log('🌱 Exécution des seeders de développement...\n');

    const seedersPath = path.join(__dirname, '../../seeders/dev');
    ...
    console.log('✨ Tous les seeders de développement ont été exécutés avec succès!');
    process.exit(0);
  } catch (error) {
